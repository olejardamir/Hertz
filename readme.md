...
While discussing Hertz online during a development, the eavesdroppers have done their task and created a poor copy of Hertz token. Please be aware of the other projects which claim to do the same thing as Hertz. If some project claims that they have borrowed Hertz code, please double-check their source-code to avoid getting scammed. It is extremely easy to turn this project into a ponzi-shceme. Furthermore, Check their source code history for any development, and you will see which one was gradually developed and which one was a copy-paste and a mockery. Direct evidence will be provided in as a separate document.
